...
---------------------------------------
-- 시스템 권한
SELECT * FROM DBA_SYS_PRIVS WHERE GRANTEE = 'FKMPDCM2';

-- 오브젝트 권한
SELECT * FROM DBA_TAB_PRIVS WHERE GRANTEE = 'FKMPDCM2';

-- 부여된 롤
SELECT * FROM DBA_ROLE_PRIVS WHERE GRANTEE = 'FKMPDCM2';

-- 롤에 포함된 세부 권한까지 보려면
SELECT * FROM DBA_SYS_PRIVS WHERE GRANTEE IN (
    SELECT GRANTED_ROLE FROM DBA_ROLE_PRIVS WHERE GRANTEE = 'FKMPDCM2'
);
